parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.tarak.cloud:8080/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://user-dev.tarak.cloud:8080/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.tarak.cloud:8080/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.tarak.cloud:8080/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.tarak.cloud:8080/", type = "String" },
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.tarak.cloud:27017/users", type = "String" },
